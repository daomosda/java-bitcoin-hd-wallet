...
public class LightningServiceImpl implements LightningService {
    ...
    private static String className = "LightningServiceImpl";
    ...
    public void pushFunds(String channelId, long amountMsat)
        ...
        AppLogger.info(className, " After push: local={} msat remote={} msat",
    ...
    public Map.Entry<Invoice, byte[]> createInvoice(long   amountSat,
                                                     String payeePubKey)
            throws LightningServiceException {
        AppLogger.info(className, " createInvoice: amount={} sat", amountSat);
    ...
    public void notifyIncomingHtlc(String channelId, HTLC htlc) {
        ...
        AppLogger.info(className, " Incoming HTLC registered: {}", htlc);
    }
    ...
    public void fulfillHTLC(String channelId,
        ...
        AppLogger.info(className, " HTLC fulfilled: localMsat={} remoteMsat={}",
            state.localMsat, state.remoteMsat);
    }
    ...
    public void settleHTLC(String channelId,
        ...
        AppLogger.info(className, " HTLC settled: localMsat={} remoteMsat={}",
            state.localMsat, state.remoteMsat);
    }
    ...
    public void failPendingHtlcs(String channelId)
        ...
        for (HTLC htlc : state.pendingHtlcs.values()) {
            if (htlc.getDirection() == HTLC.Direction.OFFERED) {
                state.localMsat += htlc.getAmountMsat();
                AppLogger.info(className, " Restored {} msat from failed HTLC",
                    htlc.getAmountMsat());
            }
        }
        ...
        AppLogger.info(className, " Failed {} pending HTLC(s) on channel={}",
            count, channelId);
    }
    ...
    public void printChannelBalance(String channelId)
        ...
        AppLogger.info(className, " ── Channel Balance ───────────────────");
        AppLogger.info(className, "   Channel   : {}", channelId);
        AppLogger.info(className, "   Capacity  : {} sat", capacitySat);
        AppLogger.info(className, "   Local     : {} sat  ({} msat)",
            localSat,  state.localMsat);
        AppLogger.info(className, "   Remote    : {} sat  ({} msat)",
            remoteSat, state.remoteMsat);
        AppLogger.info(className, "   Pending   : {} HTLC(s)",
