...
public final class CoinSelector {
    ...
    private static String className = "CoinSelector";
    ...
    public List<Utxo> select(BigDecimal targetAmount) throws Exception {
        ...
        if (utxos.isEmpty()) {
            throw new IllegalStateException(
                    "No mature spendable Utxos available."
        ...
        for (Utxo utxo : utxos) {
            ...
            AppLogger.info(className, "Adding Utxo: txid={}:{}"
        ...
        AppLogger.info(className, "Selected {} Utxo(s) totalling {} BTC"
                + " to cover {} BTC",
    ...
    private List<Utxo> getMatureSpendableUtxosFromCore() throws Exception {
        ...
        AppLogger.info(className, "Mature spendable Utxos from Core: {}",
                result.size());
        return result;
    }
}
