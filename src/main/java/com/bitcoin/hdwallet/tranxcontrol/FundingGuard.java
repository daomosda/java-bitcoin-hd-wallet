...
public final class FundingGuard {
    ...
    private static String className = "FundingGuard";
    ...
    public FundingResult ensureFunded(
        ...
        AppLogger.info(className, "Checking funds:"
    ...
    private FundingResult mineUntilFunded(
        ...
        AppLogger.warn(className, "Insufficient funds ({} BTC < {} BTC)."
                + " Mining blocks...",
        ...
        AppLogger.info("Mining to: {}", miningAddress);
        ...
        while (current.spendableBalance.compareTo(needed) < 0) {
            ...
            if (rounds >= MAX_MINE_ROUNDS) {
                throw new IllegalStateException(String.format(
                        "Reached mining cap of %d rounds."
            ...
            AppLogger.info(className, "Round {}: mined block {}",
                    rounds,
            ...
            AppLogger.info(className, "After round {}: balance={} BTC"
                    + " utxos={} needed={} BTC",
                    rounds,
                    current.spendableBalance,
                    current.utxoCount(),
        ...
        AppLogger.info(className, "✅ Funded after {} round(s)."
                + " Final balance: {} BTC",
