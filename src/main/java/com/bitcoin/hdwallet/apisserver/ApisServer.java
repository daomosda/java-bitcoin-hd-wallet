...
import com.bitcoin.hidzmq.hdwallet.HIDZMQHDWallet;
...
public class ApisServer {
    ...
    private static String className = "ApisServer";

    private final HttpServer server;
    private final HIDZMQHDWallet hdWallet;  // your main app / controller object

    public ApisServer(int port, HIDZMQHDWallet hdWallet) throws IOException {
    ...
    public void start() {
        server.start();
         AppLogger.info(className, "HTTP API server started on port {}", server.getAddress().getPort());
    }

    public void stop() {
        server.stop(0);
         AppLogger.info(className, "HTTP API server stopped.");
    }
    ...
    class SendCoinsHandler implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            try {
                ...
                String result = hdWallet.sendCoinsApi(
                    req.getToAddress(),
                    req.getAmountBtc(),
                    req.getTargetBlocks()
                );
                ...
                AppLogger.error("sendCoinsApi failed: {}", e.getMessage(), e);
    ...
    class MerchantReceiveHandler implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            try {
                ...
                AppLogger.error("receivePaymentAPIs failed: {}", e.getMessage(), e);
                sendResponse(exchange, 500, "{\"error\":\"" + e.getMessage() + "\"}");
    ...
    class CustomerPaymentHandler implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            try {
                ...
                AppLogger.error("makeCustomerPaymentApi failed: {}", e.getMessage(), e);
                sendResponse(exchange, 500, "{\"error\":\"" + e.getMessage() + "\"}");
            }
        }
    }
    ...
    class MineBlocksHandler implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            try {
                ...
                AppLogger.error("mineBlocks failed: {}", e.getMessage(), e);
                sendResponse(exchange, 500, "{\"error\":\"" + e.getMessage() + "\"}");
            } catch (Exception ex) {
                System.getLogger(ApisServer.class.getName()).log(System.Logger.Level.ERROR, (String) null, ex);
            }
    ...
    class DelegationHandler implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            try {
                ...
                AppLogger.error("handleDelegation failed: {}", e.getMessage(), e);
                sendResponse(exchange, 500, "{\"error\":\"" + e.getMessage() + "\"}");
            }
        }
    }
    ...
    class ConsolidateChangeHandler implements HttpHandler {
        ...
        public void handle(HttpExchange exchange) throws IOException {
            ...
            try {
                ...
                AppLogger.error("consolidateChange failed: {}", e.getMessage(), e);
                sendResponse(exchange, 500, "{\"error\":\"" + e.getMessage() + "\"}");
            } catch (Exception ex) {
                System.getLogger(ApisServer.class.getName()).log(System.Logger.Level.ERROR, (String) null, ex);
            }
